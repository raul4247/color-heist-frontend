export function FontColor(color){
    ...
    let luminance = ((0.299 * h[0]) + (0.587 * h[1]) + (0.114 * h[2])) / 255
    let d = (luminance > 0.5 ? 0 : 255)

    return 'rgb(' + d +', '+ d + ', '+ d + ')'
}

export function nameColorHEX(color) {
    let names = [
        ["000000", "Black"],
        ["000080", "Navy Blue"],
        ["0000C8", "Dark Blue"],
    ...
    let r0 = parseInt("0x" + names[0][0].substr(0,2) , 16)
    let g0 = parseInt("0x" + names[0][0].substr(2,2) , 16)
    let b0 = parseInt("0x" + names[0][0].substr(4,2) , 16)
    
    let min = Math.pow(Math.pow((r0-r), 2) + Math.pow((g0-g), 2) + Math.pow((b0-b), 2), 0.5)
    let lowest = 0
    ...
    for (let i = 0; i < names.length; i++) {
        ...
        r0 = parseInt("0x" + names[i][0].substr(0,2) , 16)
        g0 = parseInt("0x" + names[i][0].substr(2,2) , 16)
        b0 = parseInt("0x" + names[i][0].substr(4,2) , 16)
    
        let dist = Math.pow(Math.pow((r0-r), 2) + Math.pow((g0-g), 2) + Math.pow((b0-b), 2), 0.5)
